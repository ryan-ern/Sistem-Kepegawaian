                        ...
                        <div class="p-4 md:p-5 space-y-4 overflow-y-auto max-h-[80vh]">
                            <div class="wrap w-full md:flex-row flex-col  flex gap-3 md:gap-8">
                                ...
                                <div class="md:w-1/2 w-full flex flex-col gap-3 md:gap-6">
                                    <div class="wrap">
                                        <div class="flex flex-col md:flex-row items-start md:items-center md:gap-5 gap-1 justify-between">
                                            <label For="image" class="text-[#B3B3B3] font-medium text-[14px]">Foto Profil</label>
                                            <div class="relative">
                                                <input type="file" id="image" accept="image/*" class="hidden"  />
                                                <label for="image"
                                                    class="cursor-pointer bg-[#4F8EA5] text-white  py-2 px-4 rounded-lg inline-block w-[340px]">
                                                    Unggah File
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="wrap">
                                        ...
                                        <div class="flex flex-col md:flex-row items-start md:items-center md:gap-5 gap-1 justify-between">
                                            ...
                                            <input type="text" class="isi font-medium text-[#4F8EA5] p-2 px-4 border focus:ring-[#4F8EA5] focus:border-[#4F8EA5] border-[#4F8EA5] rounded-[8px] w-[340px]" placeholder="Masukkan Nomer Telepon">
                                        </div>
                                    </div>
                                    <div class="wrap">
                                        <div class="garis w-full h-[1px] mb-3 md:mb-6 bg-[#C3C3C3]"></div>
