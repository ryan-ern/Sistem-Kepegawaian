    ...
    <x-sidebar-admin>
        ...
        <div class="wrap flex flex-col md:flex-row gap-3 md:gap-8">
            <div class="left w-full md:w-[12%] ">
                ...
                <div class="wrap-menu mt-5 flex flex-col gap-3">
                    ...
                    <a href="{{ route('user.pmk', $user->first()->user_id) }}"
                        class="w-full p-3 text-white bg-[#093545] text-center rounded-md text-[14px]">
            ...
            <div class="right w-full md:w-[88%]">
                <form action="{{ route('user.pmkUpdate', $user->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="hea flex justify-between">
                        <div class="text-[#2F5B6B] font-semibold text-[22px]">Data Peninjauan Masa Kerja</div>
                            ...
                            <div class="md:w-1/2 w-full flex flex-col gap-3 md:gap-6">
                                <div class="wrap">
                                    ...
                                    <div
                                        ...
                                        <label For="" class="text-black font-medium text-[14px]">Jenis
                                            Peninjauan
                                            Masa Kerja</label>
                                        <input type="text" value="{{ $user->masa_kerja }}" required
                                            name="masa_kerja"
                                ...
                                <div class="wrap">
                                    ...
                                    <div
                                        ...
                                        <input type="text" value="{{ $user->instansi }}" required name="instansi"
                                            class="isi font-semibold text-[#2F5B6B] p-1 px-4 border focus:ring-[#2F5B6B] focus:border-[#2F5B6B] border-[#C3C3C3] rounded flex-shrink-0 w-[380px]">
                                    </div>
                                </div>
                                <div class="wrap">
                                    ...
                                    <div
                                        ...
                                        <label For="" class="text-black font-medium text-[14px]">Tanggal
                                            Awal</label>
                                        <input type="text" value="{{ $user->tgl_awal }}" required name="tgl_awal"
                                            class="isi font-semibold text-[#2F5B6B] p-1 px-4 border focus:ring-[#2F5B6B] focus:border-[#2F5B6B] border-[#C3C3C3] rounded flex-shrink-0 w-[380px]">
                                    </div>
                                </div>
                                <div class="wrap">
                                    ...
                                    <div
                                        ...
                                        <label For="" class="text-black font-medium text-[14px]">Tanggal
                                            Akhir</label>
                                        <input type="text" value="{{ $user->tgl_akhir }}" required name="tgl_akhir"
                                            class="isi font-semibold text-[#2F5B6B] p-1 px-4 border focus:ring-[#2F5B6B] focus:border-[#2F5B6B] border-[#C3C3C3] rounded flex-shrink-0 w-[380px]">
                                    </div>
                                </div>
                                <div class="wrap">
                                        ...
                                        <div
                                            ...
                                            <div class="p-4 md:p-5 space-y-4 overflow-y-auto max-h-[80vh]">
                                                <div class="wrap flex items-center gap-8 flex-col">
                                                    ...
                                                    <form action="{{ route('file.pmk.delete', $file->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
