        ...
        <div class="wrap flex flex-col md:flex-row gap-3 md:gap-8">
            ...
            <div class="right w-full md:w-[88%]">
                ...
                <div class="tab flex gap-2">
                    <a href="/admin/edit-pegawai/keluarga-orangtua" class="font-medium text-[#4F8EA5] underline">Orang Tua</a>
                    <a href="/admin/edit-pegawai/keluarga-pasangan" class="font-medium text-[#B3B3B3] ">Pasangan</a>
