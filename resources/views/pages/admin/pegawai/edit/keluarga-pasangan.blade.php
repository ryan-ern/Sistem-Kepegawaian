        ...
        <div class="wrap flex flex-col md:flex-row gap-3 md:gap-8">
            <div class="left w-full md:w-[12%] ">
                ...
                <div class="wrap-menu mt-5 flex flex-col gap-3">
                    <a href="/admin/edit-pegawai/pendidikan" class="w-full p-3 text-white bg-[#4F8EA5] text-center rounded-md">
                        Pendidikan
                    </a>
                    <a href="/admin/edit-pegawai/keluarga-orangtua" class="w-full p-3 text-white bg-[#093545] text-center rounded-md">
                        Keluarga
                    </a>
            ...
            <div class="right w-full md:w-[88%]">
                ...
                <div class="tab flex gap-2">
                    ...
                    <a href="/admin/edit-pegawai/keluarga-pasangan" class="font-medium text-[#4F8EA5]  underline ">Pasangan</a>
