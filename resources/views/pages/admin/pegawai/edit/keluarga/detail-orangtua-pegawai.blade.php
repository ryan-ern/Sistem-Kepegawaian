    ...
    <x-sidebar-admin>
        ...
        <div class="wrap flex flex-col md:flex-row gap-3 md:gap-8">
            ...
            <div class="right w-full md:w-[88%]">
                <form action="{{ route('user.ortuUpdate', $user->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="tab flex gap-2">
                        <a href="{{ route('user.ortuShow', $user->first()->user_id) }}"
                            class="font-medium text-[#4F8EA5] underline">Orang
                            Tua</a>
                                ...
                                <div class="wrap">
                                    ...
                                    <div
                                        ...
                                        <select name="status_pernikahan" required
                                            ...
                                            id="cars">
                                            <option value="Kawin"
                                                {{ $user->status_pernikahan == 'Kawin' ? 'selected' : '' }}>
                                                Kawin</option>
                            ...
                            <div class="md:w-1/2 w-full flex flex-col gap-3 md:gap-6">
                                <div class="wrap">
                                    ...
                                    <div
                                        ...
                                        <label For="" class="text-black font-medium text-[14px]">Tanggal
                                            Lahir</label>
                                        <input type="text" required name="tgl_lahir"
                                ...
                                <div class="wrap">
                                    ...
                                    <div
                                        ...
                                        <label For="" class="text-black font-medium text-[14px]">Nomor
                                            Identitas</label>
                                        <input type="text" required name="no_identitas"
                                ...
                                <div class="wrap">
                                    ...
                                    <div
                                        ...
                                        <label For="" class="text-black font-medium text-[14px]">Nomor
                                            Telepon</label>
                                        <input type="text" required name="no_tel" value="{{ $user->no_tel }}"
                                            class="isi font-semibold text-[#2F5B6B] p-1 px-4 border focus:ring-[#2F5B6B] focus:border-[#2F5B6B] border-[#C3C3C3] rounded w-[380px]">
                                    </div>
                                </div>
                                <div class="wrap">
                                    ...
                                    <div
                                        ...
                                        <label For="" class="text-black font-medium text-[14px]">Nomor
                                            Handphone</label>
                                        <input type="text" required name="no_hp" value="{{ $user->no_hp }}"
                                            class="isi font-semibold text-[#2F5B6B] p-1 px-4 border focus:ring-[#2F5B6B] focus:border-[#2F5B6B] border-[#C3C3C3] rounded w-[380px]">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div
                                        ...
                                        <div class="p-4 md:p-5 space-y-4 overflow-y-auto max-h-[80vh]">
                                            <div class="wrap flex items-center gap-8 flex-col">
                                                ...
                                                <form action="{{ route('file.ortu.delete', $file->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
