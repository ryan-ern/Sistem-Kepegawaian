                            ...
                            <div class="wrap">
                                ...
                                <div
                                    ...
                                    <select
                                        ...
                                        <option value="Satyalancana Karya Satya 10 Tahun">Satyalancana Karya Satya 10
                                            Tahun</option>
                                        <option value="Satyalancana Karya Satya 20 Tahun">Satyalancana Karya Satya 20
                                            Tahun</option>
                                        <option value="Satyalancana Karya Satya 20 Tahun">Satyalancana Karya Satya 20
                                            Tahun</option>
                                        <option value="Satyalancana Karya Satya 30 Tahun">Satyalancana Karya Satya 30
                                            Tahun</option>
                                        <option value="Satyalancana Wira Karya">Satyalancana Wira Karya</option>
                                        <option value="Satyalancana Perintis Kemerdekaan">Satyalancana Perintis
                                            Kemerdekaan</option>
                                        <option value="Satyalancana Pembangunan">Satyalancana Pembangunan</option>
                                        <option value="Satyalancana Kebaktian Sosial">Satyalancana Kebaktian Sosial
                                        </option>
                                        ...
                                        <option value="Satyalancana Dharma Olahraga">Satyalancana Dharma Olahraga
                                        </option>
                                        ...
                                        <option value="Satyalancana Karya Bhakti Praja Nugraha">Satyalancana Karya
                                        ...
                                        <option value="TP Teladan TK Kabupaten/Kota">TP Teladan TK Kabupaten/Kota
                                        </option>
                                        <option value="TP PNS Luar Biasa Prestasinya">TP PNS Luar Biasa Prestasinya
                                        </option>
                                        <option value="TP Penemuan Bermanfaat bagi Negara">TP Penemuan Bermanfaat bagi
                                            Negara</option>
