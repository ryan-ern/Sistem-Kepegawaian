    ...
    <x-sidebar-admin>
        ...
        <div class="wrap flex flex-col md:flex-row gap-3 md:gap-8">
            ...
            <div class="right w-full md:w-[88%]">
                <form action="{{ route('user.jabatanUpdate', $user->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="md:w-1/2 w-full flex flex-col gap-3 md:gap-6">
                                <div class="wrap">
                                    ...
                                    <div
                                        ...
                                        <label For="" class="text-black font-medium text-[14px]">Jenis
                                            Jabatan</label>
                                        <input type="text" name="jenis_jabatan" value="{{ $user->jenis_jabatan }}"
                                            required
                                ...
                                <div class="wrap">
                                    ...
                                    <div
                                        ...
                                        <label For="" class="text-black font-medium text-[14px]">Jenis
                                            Mutasi</label>
                                        <input type="text" name="mutasi" value="{{ $user->mutasi }}" required
                                            class="isi font-semibold text-[#2F5B6B] p-1 px-4 border focus:ring-[#2F5B6B] focus:border-[#2F5B6B] border-[#C3C3C3] rounded flex-shrink-0 w-[380px]">
                                    </div>
                                </div>
                                <div class="wrap">
                                    ...
                                    <div
                                        ...
                                        <label For="" class="text-black font-medium text-[14px]">Jenis
                                            Penugasan</label>
                                        <input type="text" name="penugasan" value="{{ $user->penugasan }}" required
                                            class="isi font-semibold text-[#2F5B6B] p-1 px-4 border focus:ring-[#2F5B6B] focus:border-[#2F5B6B] border-[#C3C3C3] rounded flex-shrink-0 w-[380px]">
                                    </div>
                                </div>
                                <div class="wrap">
                                    ...
                                    <div
                                        ...
                                        <label For="" class="text-black font-medium text-[14px]">Tanggal
                                            SK</label>
                                        <input type="text" name="tgl_sk" value="{{ $user->tgl_sk }}" required
                                            class="isi font-semibold text-[#2F5B6B] p-1 px-4 border focus:ring-[#2F5B6B] focus:border-[#2F5B6B] border-[#C3C3C3] rounded flex-shrink-0 w-[380px]">
                                    </div>
                                </div>
                                <div class="wrap">
                                    ...
                                    <div
                                        ...
                                        <label For="" class="text-black font-medium text-[14px]">Tanggal TMT
                                            Jabatan</label>
                                        <input type="text" name="tgl_tmt" value="{{ $user->tgl_tmt }}" required
                                            class="isi font-semibold text-[#2F5B6B] p-1 px-4 border focus:ring-[#2F5B6B] focus:border-[#2F5B6B] border-[#C3C3C3] rounded flex-shrink-0 w-[380px]">
                                    </div>
                                </div>
                                <div class="wrap">
                                    ...
                                    <div
                                        ...
                                        <label For="" class="text-black font-medium text-[14px]">Tanggal TMT
                                            Pelantikan</label>
                                        <input type="text" name="tgl_tmt_pelantikan"
                                            value="{{ $user->tgl_tmt_pelantikan }}" required
                                            class="isi font-semibold text-[#2F5B6B] p-1 px-4 border focus:ring-[#2F5B6B] focus:border-[#2F5B6B] border-[#C3C3C3] rounded flex-shrink-0 w-[380px]">
                                    </div>
                                </div>
                                <div class="wrap">
                                    ...
                                    <div
                                        ...
                                        <label For="" class="text-black font-medium text-[14px]">Nomor
                                            SK</label>
                                        <input type="text" name="no_sk" value="{{ $user->no_sk }}" required
                                            class="isi font-semibold text-[#2F5B6B] p-1 px-4 border focus:ring-[#2F5B6B] focus:border-[#2F5B6B] border-[#C3C3C3] rounded flex-shrink-0 w-[380px]">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="wrap">
                                    ...
                                    <div
                                        ...
                                        <label For="" class="text-black font-medium text-[14px]">Status
                                            Riwayat</label>
                                        <input type="text" name="status_riwayat"
                                            value="{{ $user->status_riwayat }}" required
                                            class="isi font-semibold text-[#2F5B6B] p-1 px-4 border focus:ring-[#2F5B6B] focus:border-[#2F5B6B] border-[#C3C3C3] rounded flex-shrink-0 w-[380px]">
                                    </div>
                                </div>
                                <div class="wrap">
                                    ...
                                    <div
                                        ...
                                        <input type="text" name="instansi" value="{{ $user->instansi }}" required
                                            class="isi font-semibold text-[#2F5B6B] p-1 px-4 border focus:ring-[#2F5B6B] focus:border-[#2F5B6B] border-[#C3C3C3] rounded flex-shrink-0 w-[380px]">
                                    </div>
                                </div>
                                <div class="wrap">
                                    ...
                                    <div
                                        class="flex flex-col md:flex-row items-start md:items-center md:gap-5 gap-1 justify-between">
                                        <label For="" class="text-black font-medium text-[14px]">Satuan
                                            Kerja</label>
                                        <input type="text" name="sk" value="{{ $user->sk }}" required
                                            class="isi font-semibold text-[#2F5B6B] p-1 px-4 border focus:ring-[#2F5B6B] focus:border-[#2F5B6B] border-[#C3C3C3] rounded flex-shrink-0 w-[380px]">
                                    </div>
                                </div>
                                <div class="wrap">
                                    ...
                                    <div
                                        class="flex flex-col md:flex-row items-start md:items-center md:gap-5 gap-1 justify-between">
                                        <label For="" class="text-black font-medium text-[14px]">Satuan Kerja
                                            Induk</label>
                                        <input type="text" name="sk_induk" value="{{ $user->sk_induk }}" required
                                            class="isi font-semibold text-[#2F5B6B] p-1 px-4 border focus:ring-[#2F5B6B] focus:border-[#2F5B6B] border-[#C3C3C3] rounded flex-shrink-0 w-[380px]">
                                    </div>
                                </div>
                                <div class="wrap">
                                    ...
                                    <div
                                        ...
                                        <label For="" class="text-black font-medium text-[14px]">Unit
                                            Organisasi</label>
                                        <input type="text" name="unit_organisasi"
                                            value="{{ $user->unit_organisasi }}" required
                                            class="isi font-semibold text-[#2F5B6B] p-1 px-4 border focus:ring-[#2F5B6B] focus:border-[#2F5B6B] border-[#C3C3C3] rounded flex-shrink-0 w-[380px]">
                                    </div>
                                </div>
                                <div class="wrap">
                                    ...
                                    <div
                                        ...
                                        <label For="" class="text-black font-medium text-[14px]">Nama
                                            Jabatan</label>
                                        <input type="text" name="nama_jabatan" value="{{ $user->nama_jabatan }}"
                                            required
                                            class="isi font-semibold text-[#2F5B6B] p-1 px-4 border focus:ring-[#2F5B6B] focus:border-[#2F5B6B] border-[#C3C3C3] rounded flex-shrink-0 w-[380px]">
                                    </div>
                                </div>
                                        ...
                                        <div
                                            ...
                                            <div class="p-4 md:p-5 space-y-4 overflow-y-auto max-h-[80vh]">
                                                <div class="wrap flex items-center gap-8 flex-col">
                                                    ...
                                                    <form action="{{ route('file.jabatan.delete', $file->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
