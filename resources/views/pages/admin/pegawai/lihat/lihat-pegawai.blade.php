                            ...
                            <div class="w-full flex flex-col gap-3 md:gap-3">
                                <div class="wrap-content">
                                    <div
                                        ...
                                        <button data-modal-target="detailkinerja" data-modal-toggle="detailkinerja">
                                            <img src="../Assets/book.svg" alt="">
                                        </button>
                                    </div>
                                    <div
                            ...
                            <div class="w-full flex flex-col gap-3 md:gap-3">
                                <div class="wrap-content">
                                    <div
                                        ...
                                        <button data-modal-target="detaildiklat" data-modal-toggle="detaildiklat">
                                            <img src="../Assets/book.svg" alt="">
                                        </button>
                                    </div>
                                    <div
                            ...
                            <div class="w-full flex flex-col gap-3 md:gap-3">
                                <div class="wrap-content">
                                    <div
                                        ...
                                        <button data-modal-target="detailjabatan" data-modal-toggle="detailjabatan">
                                            <img src="../Assets/book.svg" alt="">
                                        </button>
                                    </div>
                                    <div
                                    ...
                                    <div class="md:w-1/2 w-full flex flex-col gap-3 md:gap-3">
                                        ...
                                        <div class="wrap">
                                            ...
                                            <div
                                                class="flex flex-col md:flex-row items-start md:items-center md:gap-5 gap-1">
                                                <label For=""
                                                    class="text-black font-medium w-[240px] flex-shrink-0">Nomor Akta
                                                    Menikah</label>
