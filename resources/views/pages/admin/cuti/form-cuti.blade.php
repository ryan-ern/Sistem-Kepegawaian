        ...
        <div class="">
            ...
            <div class="form mt-5">
                ...
                <div class="wrap flex mt-[60px] gap-3">
                    ...
                    <button data-modal-target="ditolak" data-modal-toggle="ditolak"
                        class="p-2 bg-[#9BB8C3] hover:bg-[#4F8EA5] px-16 rounded text-white">Tolak</button>
                </div>
            </div>
            {{-- POP UP Setuju --}}
