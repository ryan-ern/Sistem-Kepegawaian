    ...
    <div class="m-0 box-border md:flex h-screen w-full bg-[url('../../Assets/bgadmin.png')] bg-no-repeat bg-cover">
        <div class="w-full relative">
            <div class="h-screen flex flex-col items-center justify-center">
                <div
                    class="z-10 bg-[#093545] pl-7 pr-7 pt-5 pb-5 w-[90%] md:w-[40%] rounded-xl drop-shadow-2xl">
                    <div class="head justify-center pt-3 text-white gap-1 items-center font-semibold text-[32px] mb-4 flex">
