    ...
    <x-sidebar-user title="Ubah Profil Anda">
        ...
        <div class="kirim flex justify-end mt-5">
            <div class="wrap flex gap-3">
                <a href="/edit-profile" class="bg-[#2F5B6B] text-white py-2 px-8 rounded-lg">Kembali</a>
                <button class="bg-[#2F5B6B] text-white py-2 px-8 rounded-lg">Simpan Perubahan</button>
            </div>
        </div>
    </x-sidebar-user>
</body>
