...
<head>
    ...
    <title>Riwayat Pengajuan Jabatan</title>
...
<body>
    <x-sidebar-user title="Riwayat Pengajuan jabatan">
        <div class="font-semibold text-[#2F5B6B] mb-2 md:mb-4">
            Berikut tampilan riwayat pengajuan jabatan
        </div>
            ...
            @foreach ($jabatanData as $g)
                <div class="data flex flex-col p-2 pl-0 pr-5 gap-1">
                    <div class="wrap flex justify-between items-center">
                        <div class="wrap">
                            <div class="">Mengusulkan perubahan riwayat jabatan</div>
