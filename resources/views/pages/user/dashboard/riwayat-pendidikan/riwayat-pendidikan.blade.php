...
<body>
    <x-sidebar-user title="Riwayat pendidikan">
        <div
            class="wrap mb-[10px] md:mb-[35px] flex flex-col md:flex-row justify-start md:justify-between items-start md:items-center">
            <p class="text-[14px] md:text-[16px]">Berikut tampilan data pendidikan anda</p>
            <div class="btnn flex items-center gap-2">
                <a href="/dashboard/riwayat-pendidikan/pengajuan-pendidikan"
                ...
                <a href="/dashboard/riwayat-pendidikan/tambah-pendidikan"
                    class="bt1 hover:bg-[#4F8EA5] bg-[#2F5B6B] text-white flex items-center gap-2 p-1 px-2 text-center rounded">
                    <div class="ic">
        ...
        <div class="wrap-content">
            @foreach ($pendidikanData as $p)
                <div class="data flex items-center justify-between border-2 border-[#969BA0] p-3 px-6">
                    <div class="wrap">
                        <div class="text-[18px] font-medium">{{ $p->tingkat_pendidikan }}</div>
                        <div class="text-[16px]">- {{ $p->pendidikan }}</div>
                    </div>
                    <a href="{{ route('pendidikan.show', $p->id) }}" class="link">
