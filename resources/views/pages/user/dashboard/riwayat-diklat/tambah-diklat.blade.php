...
">Pengembangan Kompetensi Dalam Bentuk Pelatihan Klasikal Lainnya
                            ...
                            <option value="Pertukaran Antara PNS Dengan Pegawai">Pertukaran Antara PNS Dengan Pegawai</option>
                            <option value="Swasta/Badan Usaha Milik Negara/Badan Usaha">Swasta/Badan Usaha Milik Negara/Badan Usaha</option>
                            <option value="Milik Daerah">Milik Daerah</option>
                            <option value="Belajar Mandiri (Self Development)">Belajar Mandiri (Self Development)</option>
                            <option value="Komunitas Belajar (Community Of Practices)">Komunitas Belajar (Community Of Practices)</option>
                            <option value="Bimbingan Di Tempat Kerja">Bimbingan Di Tempat Kerja</option>
                            <option value="Pengembangan Kompetensi Dalam Bentuk Pelatihan Nonklasikal Lainnya">Pengembangan Kompetensi Dalam Bentuk Pelatihan Nonklasikal Lainnya</option>
                        </select>
                    </div>
                    <div class="wrap">
...
">Pendidikan Tingkat Taman Kanak-Kanak, Dasar, Lanjutan, dan Sekolah Khusus
                            ...
                            <option value="Arsitek, Insinyur, dan Yang Berkaitan">Arsitek, Insinyur, dan Yang Berkaitan</option>
                            <option value="Administrasi Kependudukan Pencatatan Sipil">Administrasi Kependudukan Pencatatan Sipil</option>
                            ...
                            <option value="Imigrasi, Pajak, dan Asisten Profesional Yang Berkaitan">Imigrasi, Pajak, dan Asisten Profesional Yang Berkaitan</option>
                            ...
                            <option value="Matematika, Statistika, dan Yang Berkaitan">Matematika, Statistika, dan Yang Berkaitan</option>
                            ...
                            <option value="Fisika, Kimia, dan Yang Berkaiatan">Fisika, Kimia, dan Yang Berkaiatan</option>
                            <option value="Statistik">Statistik</option>
                            <option value="Profesional Bidang Pendidikan Lainnya">Profesional Bidang Pendidikan Lainnya</option>
                            ...
                            <option value="Arsiparis, Pustakawan, dan Yang Berkaitan">Arsiparis, Pustakawan, dan Yang Berkaitan</option>
                            ...
                            <option value="Asisten Profesional Yang Berhubungan Dengan Keuangan dan Penjualan">Asisten Profesional Yang Berhubungan Dengan Keuangan dan Penjualan</option>
                            ...
                            <option value="Ketenteraman dan Ketertiban Umum Serta Perlindungan Masyarakat">Ketenteraman dan Ketertiban Umum Serta Perlindungan Masyarakat</option>
