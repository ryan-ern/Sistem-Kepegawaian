...
<body>
    <div class="wrap flex h-screen w-full">
        <div
            class="left hidden md:block w-full h-full md:w-1/2 bg-[url('../../Assets/bgadmin.png')] bg-no-repeat bg-cover">
        </div>
        <div class="right w-full h-full md:w-1/2 bg-[#093545]">
            <div class="w-full relative">
                <div class="h-screen flex flex-col items-center justify-center">
                    <div class="z-10 bg-[#D9D9D9] pl-7 pr-7 pt-5 pb-5 w-[90%] md:w-[80%] rounded-xl drop-shadow-2xl">
                        <div
                            class="head justify-center pt-3 text-[#093545] gap-1 items-center font-semibold text-[32px] mb-4 flex">
                            <div class="logo w-[70px] aspect-auto">
                        ...
                        <form method="POST" action="{{ route('user.login.submit') }}">
                            @csrf
                            @if ($errors->has('nip'))
                                <span class="text-red-500 text-sm">{{ $errors->first('nip') }}</span>
                            @endif
                            <div class="text-black">
                                <div class="mb-[20px]">
                                    <input type="nip" name="nip" id="nip" placeholder="Masukkan NIP"
                            ...
                            <div class="wrap flex flex-col items-center gap-1 mt-3">
                                <button type="submit"
                                    class="text-white w-[40%] bg-[#2B2B2B] hover:bg-[#0f0f0f] focus:ring-4 focus:ring-blue-300 text-center font-medium rounded-lg text-sm px-5 py-2.5 mb-2 mt-2 ">
                                    Login
                                </button>
                            </div>
                        </form>
