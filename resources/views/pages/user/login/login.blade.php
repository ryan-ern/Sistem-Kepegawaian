...
<body>
    <div class="wrap flex h-screen w-full">
        <div class="left hidden md:block w-full h-full md:w-1/2 bg-[url('../../Assets/bgadmin.png')] bg-no-repeat bg-cover"></div>
        <div class="right w-full h-full md:w-1/2 bg-[#093545]">
            <div class="w-full relative">
                <div class="h-screen flex flex-col items-center justify-center">
                    <div
                        class="z-10 bg-[#D9D9D9] pl-7 pr-7 pt-5 pb-5 w-[90%] md:w-[80%] rounded-xl drop-shadow-2xl">
                        <div class="head justify-center pt-3 text-[#093545] gap-1 items-center font-semibold text-[32px] mb-4 flex">
