    ...
    <div class="admin">
        ...
        @php
            $pegawai = [
                'admin/pegawai',
                'admin/edit-pegawai',
                'admin/edit-pegawai/pendidikan',
                'admin/edit-pegawai/keluarga-orangtua',
                'admin/edit-pegawai/keluarga-anak',
                'admin/edit-pegawai/keluarga-pasangan',
