            ...
            <div class="menu  flex flex-col h-[80%] md:h-[100%] justify-between">
                <div class="menu flex flex-col gap-3 ">
                    ...
                    <a href="/admin/dashboard"
                        ...
                        <div class="icon">
                            <svg class="@if (in_array(Request::path(), $dashboard)) fill-[#084453] @else fill-[#616262]  @endif" width="13" height="15" viewBox="0 0 13 15" 
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <a href="/admin/pegawai"
                        ...
                        <div class="icon">
                            <svg width="14" height="18" viewBox="0 0 14 18" class="@if (in_array(Request::path(), $pegawai)) fill-[#084453] @else fill-[#616262]  @endif"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <a href="/admin/absensi"
                        ...
                        <div class="icon">
                            <svg width="16" height="20" viewBox="0 0 16 20" class="@if (in_array(Request::path(), $absensi)) fill-[#084453] @else fill-[#616262]  @endif"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <a href="/admin/cuti"
                        ...
                        <div class="icon">
                            <svg width="18" height="19" viewBox="0 0 18 19" class="@if (in_array(Request::path(), $cuti)) fill-[#084453] @else fill-[#616262]  @endif"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                ...
                <a href="/admin/login" class=" p-2 text-center rounded flex items-center gap-2 justify-center">
                    <div class="">
                    ...
                    <div class="text-[14px] font-medium text-[#D42803]">Logout</div>
                </a>
            </div>
        </div>
        {{-- CONTENT --}}
